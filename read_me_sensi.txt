...
Field Descriptions - data_sensi.csv
-----------------------------------
...
beta_mean - posterior mean of estimate for species-cell-specific sensitivity to green-up (beta_APG from Eq 9 in above publication)
beta_sd - posterior standard deviation of estimate for species-cell-specific sensitivity to green-up (beta_APG from Eq 9 in above publication)
